...
(
    ...
    `client_profile`                varchar(1000) COLLATE utf8mb4_bin          DEFAULT NULL,
    ...
    `copy_secret`                   varchar(2000) COLLATE utf8mb4_bin NOT NULL,
    PRIMARY KEY (`id`) USING BTREE
...
insert into `oauth2_registered_client`(`id`, `client_id`, `client_id_issued_at`, `client_secret`,
                                       ...
                                       `scopes`, `client_settings`, `token_settings`, `copy_secret`)
values ('1588425857037844482', '1588425647754186752', '2022-11-04 06:57:31',
        '$2a$10$8286jd6wyGwEYJXXXLWnhOjPgQEMfpzPXTZ.H66nngs99L5XEBKw6', NULL, '测试01',
        'http://k7fsqkhtbx.cdhttp.cn/system/files/1588425772870770690.jpg', 'client_secret_basic',
        'refresh_token,authorization_code',
        'http://192.168.4.88:3000/vains3-admin-template-ts/loginRedirect,http://k7fsqkhtbx.cdhttp.cn/login/oauth2/code/test01-oidc',
        'read',
        ...
        '2A3hft4aQ3jMHI8+QJBbuEYfq29OPcEFddRFEx4GDsE='),
       ...
       ('3c431544-6bd5-4c2e-ab4c-76b159d73997', 'swagger', '2022-05-16 06:15:32',
        ...
        'http://k7fsqkhtbx.cdhttp.cn/system/files/1588339450013392897.jpg', 'client_secret_post,client_secret_basic',
        'refresh_token,client_credentials,authorization_code',
